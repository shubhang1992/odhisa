...
const container = {
  hidden: {},
  show: { y: 0, opacity: 1, transition: { staggerChildren: 0.08 } },
  away: { y: 320, opacity: 0, transition: { duration: 0.4, ease: EASE } },
};
...
export default function MetricsRow() {
  const {
    ...
    viewAgentsOpen, viewSubscribersOpen,
  ...
  return (
    <motion.div
      ...
      variants={container}
      initial="hidden"
      animate={anyPanelOpen ? 'away' : 'show'}
