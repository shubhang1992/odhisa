...
export default function ContributionsCollections({ onBack }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'right',
      sortable: true,
      render: (row) => formatINR(row.latestMonthly),
    },
    {
      key: 'monthlyTrend',
      label: 'MoM',
    ...
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.dailyContributions || 0),
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.weeklyContributions || 0),
    },
    {
      key: 'avgContribution',
      ...
      align: 'right',
      sortable: true,
      render: (row) => formatINR(row.avgContribution),
    },
    {
      key: 'sparkline',
