...
export default function WithdrawalsPayouts({ onBack }) {
  ...
  const columns = [
    ...
    !isBranch && { key: 'regionName', label: 'Region', sortable: true },
    {
      ...
      render: (row) => formatINR(row.metrics?.totalWithdrawals || 0),
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.monthlyWithdrawals || 0),
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.weeklyWithdrawals || 0),
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.dailyWithdrawals || 0),
    },
    {
      key: 'withdrawalRatio',
      label: 'W/C Ratio',
    ...
    },
    {
      ...
      render: (row) => formatINR(row.metrics?.totalContributions || 0),
    },
  ].filter(Boolean);
