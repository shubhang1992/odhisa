...
import { EASE_OUT_EXPO, formatINR, fmtShort } from '../../utils/finance';
          ...
          <motion.section className={styles.section} variants={fadeUp}>
            ...
            <div className={styles.grid2}>
              <motion.button className={styles.finCard} onClick={() => go('contributions-collections')} variants={fadeIn}
                ...
                <div className={styles.finMain}>
                  <div className={styles.finMetric}>
                    <span className={styles.finValue}>{formatINR(m.totalContributions)}</span>
                ...
                <div className={styles.finFooter}>
                  <span>Daily {formatINR(m.dailyContributions)}</span>
                  <span className={styles.finDivider} />
                  <span>Weekly {formatINR(m.weeklyContributions)}</span>
                </div>
              </motion.button>
              ...
              <motion.button className={styles.finCard} onClick={() => go('withdrawals-payouts')} variants={fadeIn}
                ...
                <div className={styles.finMain}>
                  <div className={styles.finMetric}>
                    <span className={styles.finValue}>{formatINR(m.totalWithdrawals)}</span>
                  </div>
                ...
                <div className={styles.finFooter}>
                  <span>Daily {formatINR(m.dailyWithdrawals)}</span>
                  <span className={styles.finDivider} />
                  <span>Monthly {formatINR(m.monthlyWithdrawals)}</span>
                </div>
              </motion.button>
            </div>
          </motion.section>
