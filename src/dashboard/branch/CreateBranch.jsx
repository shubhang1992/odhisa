...
/* ─── Major Odisha cities and towns for city/town searchable field ────────────────────── */
const TOWNS = [
              ...
              >
                ...
                >
                  ...
                  <div className={styles.successRow}>
                    ...
                    <span className={styles.successRowText}>{adminName} &middot; +91 {adminPhone}</span>
                  </div>
                </motion.div>
                      ...
                      >
                        ...
                        <div className={styles.reviewCard}>
                          ...
                          <div className={styles.reviewGrid}>
                            ...
                            <ReviewRow label="Phone" value={`+91 ${adminPhone}`} />
