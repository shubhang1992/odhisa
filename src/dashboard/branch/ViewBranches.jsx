  ...
  return (
    <div className={styles.chartWrap}>
      <div className={styles.chartBars}>
        {data.map((v, i) => (
          <div key={i} className={styles.chartBar} data-peak={i === peakIdx} style={{ height: `${Math.max((v / max) * 100, 4)}%` }} title={`${MONTHS[i]}: ${formatINR(v)}`} />
        ))}
      </div>
  ...
  return (
    <div className={styles.detailContent}>
      ...
      <div className={styles.kpiRow}>
        ...
        <KpiCard icon={Icons.contributions} label="Contributions" value={formatINR(m.totalContributions)} />
        <KpiCard icon={Icons.aum} label="AUM" value={formatINR(m.aum)} />
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.infoCard}>
          <div className={styles.infoRow}>
            ...
            <span className={styles.infoValue}>
              <span className={styles.commAmount}>{commission ? formatINR(commission.totalPaid) : '--'}</span>
          ...
          <div className={styles.infoRow}>
            ...
            <span className={styles.infoValue}>
              <span className={styles.commAmount}>{commission ? formatINR(commission.totalDue) : '--'}</span>
          ...
          <div className={styles.infoRow}>
            ...
            <span className={`${styles.infoValue}${commission && commission.totalDisputed > 0 ? ` ${styles.commDisputed}` : ''}`}>
              <span className={styles.commAmount}>{commission ? formatINR(commission.totalDisputed) : '--'}</span>
          ...
          {section === 'admin' ? (
            <>
              ...
              <div className={styles.field}>
                ...
                <input className={styles.input} value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+91…" name="phone" type="tel" autoComplete="tel" />
              </div>
              <div className={styles.field}>
...
export default function ViewBranches() {
  ...
  let headerSubtitle = `${allBranches.length} branches across Odisha`;
